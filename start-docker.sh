...
docker run -it --security-opt seccomp=unconfined --rm -v$(pwd):/mnt/cilk-plus-futures -w=/mnt/cilk-plus-futures  -e LD_LIBRARY_PATH=/mnt/cilk-plus-futures/SuperMalloc/release/lib cilkfut
